...
export default function SignUpPage() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(
            signupUser({ fullName, email, password, profession, avatarUrl })
        );
    };
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl 
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4">
                    <div className="text-center sm:text-left">
                        <h1 className="text-xl sm:text-2xl font-bold mb-1">Create account</h1>
                    ...
                    <button
                        ...
                        px-3 py-2 rounded-lg hover:bg-green-50"
                    >
                ...
                <div className="flex flex-col items-center mt-6 mb-8">
                    ...
                    <p className="text-gray-500 text-center text-sm sm:text-base">
                        Join us to start messaging with friends
                    </p>
                </div>
